...
% Neuron Object Class
    ...
    methods
        ...
        %   delete_nrn_obj()
            ...
            % Note: we cannot call this method "delete", because that is
            % automatically run by MATLAB in some cases. For example, if we
            % call Vector.append(), and do not catch the output of that
            % method call. The output of that method is the vector itself.
            % The output is generated by neuron.stack.hoc_pop and returned,
            % but because it is not caught MATLAB calls Vector.delete() by 
            % itself...
